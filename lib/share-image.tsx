...
// e.g. components/all-leagues-badge.tsx's dark variant). Exported for other
// Satori templates (e.g. lib/match-day-image.tsx) that want the same mark.
export const LOGO_ICON_SVG = `data:image/svg+xml;base64,${Buffer.from(
